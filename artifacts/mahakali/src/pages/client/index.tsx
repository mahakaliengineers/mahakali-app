...
export default function ClientApp() {
  ...
  const projectDetailMatch = location.match(/^\/client\/projects\/(\d+)/);

  let content: React.ReactNode;
  if (projectDetailMatch) {
    content = <ClientProjectDetail projectId={parseInt(projectDetailMatch[1], 10)} />;
  } else {
    content = <ClientDashboard user={user} />;
  }
