...
import staffTestimonialsRouter from "./staff/testimonials";
import staffInquiriesRouter from "./staff/inquiries";
...
router.use(staffTestimonialsRouter);
router.use(staffInquiriesRouter);
